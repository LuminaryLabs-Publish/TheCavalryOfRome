...
- Finding: The app now routes through visual-upgrade-renderer.js, which raises lighting contrast, lowers fog washout, adds desert/tundra/forest/temperate biome overlays, increases lake UV tiling for denser water noise, hides old red/green/blue force circles, replaces bridge crossings so their long axis crosses river normals, and adds stronger carved monument terraces under temples, palaces, and castles.
