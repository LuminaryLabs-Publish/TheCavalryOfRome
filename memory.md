...
- Finding: The app routes through visual-upgrade-renderer.js. Biomes are now applied by directly recoloring the terrain vertex color buffer rather than layering transparent biome meshes. Fog was reduced further, terrain shader fog density is reduced, lake UV tiling was increased to 8x, corrected bridge crossings and carved monument terraces remain active, and the runtime marker is natural-terrain-biome-color-pass-7.
